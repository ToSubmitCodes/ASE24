...
from Futils.probability import do_type_mutation, do_select_from_db
...
class TFAPI(API):
    def __init__(self, api_name, record=None) -> None:
        ...
        self.is_class = inspect.isclass(eval(self.api[3:]))
